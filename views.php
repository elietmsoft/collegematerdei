...
<head>
   ...
   ================================================== -->
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
 	...
 	<!-- CSS
   ================================================== -->
   <link rel="stylesheet" href="www.college.mater.dei.com/css/base.css">
   <link rel="stylesheet" href="www.college.mater.dei.com/css/vendor.css">
   <link rel="stylesheet" href="www.college.mater.dei.com/css/main.css">
   <link rel="stylesheet" type="text/css" href="www.college.mater.dei.com/css-ctrl/ctrl.css">

   <!-- script
   ================================================== -->
	<script src="www.college.mater.dei.com/js/modernizr.js"></script>
	<script src="www.college.mater.dei.com/js/pace.min.js"></script>
...
<meta charset="UTF-8">	
   ...
   <nav id="menu-nav-wrap">
	  <div class="action">
		 <a class="button" href="teatcherdetail.php">RETOUR</a>
	  </div>
	</nav> <!-- /menu-nav-wrap -->
